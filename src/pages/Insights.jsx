...
const COLORS = ["#22c55e", "#3b82f6", "#f59e0b", "#ef4444", "#a21caf", "#0ea5e9", "#f43f5e"];
  ...
  <div className="p-2 sm:p-4 md:p-6 space-y-8">
    ...
    >
      {kpiCards.map((card, idx) => (
        ...
        >
          <div
            className={`relative rounded-2xl shadow-xl p-4 sm:p-6 flex flex-col items-start justify-between min-h-[140px] bg-gradient-to-br ${card.gradient} backdrop-blur-lg border border-white/20 hover:scale-[1.03] transition-transform duration-200`}
          >
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-bold text-lg tracking-wide">{card.label}</span>
            </div>
            <div className={`text-4xl font-extrabold ${card.text} drop-shadow-lg flex items-center gap-2`}>
