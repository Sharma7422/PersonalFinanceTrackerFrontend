        ...
        <Table className="min-w-full border-separate border-spacing-y-2">
          <TableHeader>
            <TableRow className="bg-indigo-100 dark:bg-indigo-900">
              {columns.map((col) => (
                <TableHead key={col} className="text-xl py-5 px-4 font-bold text-indigo-700 dark:text-indigo-200">
                  {col}
                </TableHead>
              ))}
            </TableRow>
          ...
          <TableBody>
            {records.length === 0 ? (
              ...
              records.map((record, idx) => (
                <TableRow
                  key={record._id || idx}
                  className="transition hover:bg-indigo-50 dark:hover:bg-gray-700 rounded-2xl"
                  style={{ boxShadow: "0 2px 12px 0 rgba(99,102,241,0.06)" }}
                >
                  <TableCell className="font-semibold text-lg px-4">{record.title || "-"}</TableCell>
                  <TableCell className="font-bold text-indigo-600 dark:text-indigo-400 px-4">
