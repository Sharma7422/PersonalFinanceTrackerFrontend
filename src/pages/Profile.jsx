  ...
  return (
    ...
    >
      <motion.section
        ...
        className="relative bg-gradient-to-br from-primary/10 to-white/90 dark:from-gray-900/80 dark:to-gray-800/90 shadow-2xl rounded-3xl p-4 sm:p-8 w-full max-w-2xl border border-white/30 backdrop-blur-lg"
      >
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-8 text-primary dark:text-blue-200 tracking-tight text-center">
          Update Profile
        </h2>
        <form onSubmit={handleProfileUpdate} className="space-y-8">
          ...
          >
            <motion.img
              ...
              alt="Profile"
              className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-primary/30 dark:border-blue-700 object-cover shadow-lg hover:scale-105 transition-transform duration-300"
          ...
          >
            <Button
              type="submit"
              className="bg-gradient-to-r from-primary to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-8 py-3 rounded-xl text-lg font-bold shadow-lg transition-all duration-200 w-full sm:w-auto"
              disabled={loading}
            >
