...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-primary dark:text-blue-300">Analytics Filters</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            ...
            <Button
              ...
              disabled={loading}
              className="gap-2 border-primary text-primary dark:border-blue-400 dark:text-blue-300"
              title="Refresh"
            >
        ...
        <>
            ...
            {[
              ...
              <Card key={kpi.label} className="overflow-hidden">
                <CardContent className="p-4">
                  ...
                  <div className="text-2xl font-semibold mt-1 text-primary dark:text-blue-300">{kpi.value}</div>
                </CardContent>
                <div className="h-1 w-full bg-gradient-to-r from-primary via-blue-400 to-blue-300" />
              </Card>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                <CardTitle className="text-primary dark:text-blue-300">Spending Over Time</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-primary dark:text-blue-300">By Category</CardTitle>
              </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary dark:text-blue-300">Monthly Totals</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {analytics?.budgets && analytics.budgets.length > 0 && (
            <div className="mt-8">
              <Card>
                <CardHeader>
                  <CardTitle className="text-primary dark:text-blue-300">Budgets (per category)</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {analytics.budgets.map((b) => {
                    ...
                    return (
                      <div key={b.category} className="rounded-xl border p-4 bg-background dark:bg-gray-900">
                        ...
                        <div className="mt-3">
                          ...
                          <div className="mt-2 h-3 w-full rounded-full bg-muted dark:bg-gray-800 overflow-hidden">
                            <div
                              style={{ width: `${pct}%` }}
